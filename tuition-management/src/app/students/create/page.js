          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-soft p-6 space-y-6">
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={handleChange}
                className="h-4 w-4 text-brand-orange-600 focus:ring-brand-orange-500 border-gray-300 rounded"
              />
            ...
            <div className="flex items-center justify-end space-x-4 pt-6 border-t">
              <button
                type="button"
                onClick={() => router.back()}
                className="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-orange-500"
              >
                Cancel
              </button>
              <button
                ...
                className="px-4 py-2 bg-brand-orange-500 text-white rounded-md text-sm font-medium hover:bg-brand-orange-600 focus:outline-none focus:ring-2 focus:ring-brand-orange-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
